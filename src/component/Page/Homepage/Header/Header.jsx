        ...
        <div className="z-0">
            ...
            >
                <div   >
                    ...
                    <div className="absolute md:top-[10%] lg:top-[20%] left-16">
                        <div data-aos-duration="1000" data-aos="fade-down" className="flex  items-center gap-4 ">
                            <span className="border-2 border-orange-400 w-[10px]"></span>
                        ...
                        <div
                            ...
                            className="text-left">
                            <h2 className="text-white text-[60px]">Innovative Banking  Compact <br /> Solutions For Fututre</h2>
                        </div>
                        <div data-aos-duration="1000" data-aos-delay="100" data-aos='fade-left' className="text-left">
                            <p className="text-white text-[20px]">Morbi tristique sentcuts sit amet consectetur adipiscing elit .Nunc <br /> Vulputate libero velit officiis quis saepe recusandae </p>
                        </div>
                ...
                <div >
                    ...
                    <div className="carousel-container absolute md:top-[10%] lg:top-[20%] left-16">
                        <div data-aos-duration="1000" data-aos="fade-down" className="flex  items-center gap-4 ">
                            <span className="border-2 border-orange-400 w-[25px]"></span>
                            <span className="text-white">simple & secure Payment Banking</span>
                        </div>
                        <div
                            data-aos-duration="1000" data-aos="fade-down"
